...
public class GradeServiceJdbcTemplateTest {
	...
	public void test_sauvegarder_lister_mettre_a_jour() {
		...
		Grade gradetest = new Grade("grade",new BigDecimal("35.00"),new BigDecimal("9.80"));
		...
		gradetest.setNbHeuresBase(new BigDecimal("39.00"));
		gradeService.mettreAJour(gradetest);

		// TODO vérifier que les modifications sont bien prises en compte via la méthode lister
		Grade grade= gradeService.lister().stream().filter(c->c.getCode().equals(gradetest.getCode())).findFirst().get();
